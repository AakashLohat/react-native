...
function Restaurent({ route, navigation }) {
            ...
            <View>
                ...
                >
                    <View style={{
                        ...
                        <Text style={{ ...FONTS.h3 }}>{getBakettotal()} items in cart</Text>
                    ...
                    >
                        ...
                        <View style={{
                            ...
                            <Text style={{ marginLeft: SIZES.padding }}>8</Text>
                        </View>
                    </View>
                    {/* order button */}
                    <View style={{
                        ...
                        >
                            <Text style={{ color: COLORS.white, ...FONTS.h2 }}>place irder</Text>
                        </TouchableOpacity>
                    </View>
                </View>
